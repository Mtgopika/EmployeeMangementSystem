...
public class UpdateEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfhe,tffname,tfaddress,tfphone,tfemail,tfsalary,tfdes;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add)
        {
            ...
            String he=tfhe.getText(); 
            String des=tfdes.getText();
            
            
            try{
                Conn conn=new Conn();
                String query="update employee set fname='"+fname+"',salary='"+salary+"',address='"+address+"',phone='"+phone+"',email='"+email+"',he='"+he+"',des='"+des+"' where empid='"+empid+"'";             
