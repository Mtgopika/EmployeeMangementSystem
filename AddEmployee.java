...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee()
    {
        ...
        add(labelhe); 
        String courses[]={"BBA","BCA","BA","BSC","B.COM","BTech","MBA","MA","MTech","MSC","PHD"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add)
        {
            ...
            String he=(String)tfhe.getSelectedItem();
            ...
            try{
                Conn conn=new Conn();
                String query="insert into employee values('"+name+"','"+fname+"','"+dob+"','"+salary+"','"+address+"','"+phone+"','"+email+"','"+he+"','"+des+"','"+aadhar+"','"+empid+"')";             
